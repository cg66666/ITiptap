 ...
 */
export const IHighlight = Mark.create<HighlightOptions>({
  name: 'IHighlight',
  ...
  addAttributes() {
    return {
      color: {
        default: null,
        parseHTML: (element) =>
          element.getAttribute('data-background') || element.style.backgroundColor,
        renderHTML: (attributes) => {
          ...
          return {
            'data-background': attributes.color,
